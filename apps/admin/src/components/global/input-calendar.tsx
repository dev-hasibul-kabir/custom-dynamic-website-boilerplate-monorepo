...
const InputDateField = (props: {
    ...
    if (!isRange && !isMultiple && typeof value === 'string') {
        ...
        tempValue = value.map((element: string) => moment(element, DATE_FORMAT.DATETIME_SERVER).toDate());
    }
    ...
    const handleDateSelect = (selectedDate: Date | undefined) => {
        ...
        const formattedDate = new Date(moment(selectedDate).format(DATE_FORMAT.YEAR_MM_DD)).toISOString();
