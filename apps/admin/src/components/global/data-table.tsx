                    ...
                    <TableRow>
                        <TableCell colSpan={columns.length} className="text-center">
                            <p className="text-orange-500 flex items-center justify-center gap-2">
                                ...
                                "Did you know? You can scroll horizontally by holding down the Shift key and using your
                                mouse scroll wheel. Try it out to navigate wide web pages or spreadsheets more easily!" -
                                Rafi Hasnain
